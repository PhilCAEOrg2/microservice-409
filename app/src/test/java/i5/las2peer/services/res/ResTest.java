...
public class ResTest {
  ...
  /**
   * 
   * Test for the TestCase1_ID896764 method.
   * 
   */
  @Test
  public void testTestCase1_ID896764() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 179882: " + result.getResponse().trim());
    
      Assert.assertEquals("[1514]", 200, result.getHttpCode());
